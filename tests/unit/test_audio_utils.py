...
from speech_recognition.utils.audio_utils import (
    is_file_empty,
...
def mock_from_file(mocker):
    mocker.patch("speech_recognition.utils.audio_utils.pydub.AudioSegment.from_file")
...
def test_is_file_empty_small_file(mocker, dummy_audio_path):
    ...
    mock_is_audio_empty = mocker.patch(
        "speech_recognition.utils.audio_utils.is_audio_empty"
    )
